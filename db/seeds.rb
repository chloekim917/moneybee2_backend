...
Expenditure.create(date: 20210201, category_id: food.id, detail:"bubble tea", amount: 6.34)
Expenditure.create(date: 20210202, category_id: utility.id, detail:"PSEG bill", amount: 50.04)
Expenditure.create(date: 20210203, category_id:travel.id, detail:"train ticket", amount: 44.10)
Expenditure.create(date: 20210203, category_id:entertainment.id, detail:"Tribeca Film Festival tix", amount: 23.1)
Expenditure.create(date: 20210204, category_id: food.id, detail:"In 'n Out", amount: 15.20)
Expenditure.create(date: 20210205, category_id:utility.id, detail:"Electricity bill", amount: 65.07)
Expenditure.create(date: 20210207, category_id:groceries.id, detail:"Groceries for the week", amount: 88.05)
Expenditure.create(date: 20210208, category_id:personal_care.id, detail:"facial moisturizer", amount: 55.35)
Expenditure.create(date: 20210209, category_id:transportation.id, detail:"gas", amount: 62.63)
Expenditure.create(date: 20210209, category_id:gift.id, detail:"birthday gift", amount: 57.86)
Expenditure.create(date: 20210210, category_id:medical.id, detail:"doctor co-pay", amount: 41.02)
Expenditure.create(date: 20210211, category_id:housing.id, detail:"partial rent", amount: 410.43)
