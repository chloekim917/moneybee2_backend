...
Expenditure.create(date: 20210301, category_id: food.id, detail:"bubble tea", amount: 5.0)
Expenditure.create(date: 20210301, category_id: utility.id, detail:"PSEG bill", amount: 50.0)
Expenditure.create(date: 20210303, category_id:travel.id, detail:"train ticket", amount: 40.0)
Expenditure.create(date: 20210304, category_id:entertainment.id, detail:"Tribeca Film Festival tix", amount: 25.0)
Expenditure.create(date: 20210305, category_id: food.id, detail:"In 'n Out", amount: 15.0)
Expenditure.create(date: 20210305, category_id:utility.id, detail:"Electricity bill", amount: 65.0)
Expenditure.create(date: 20210307, category_id:groceries.id, detail:"Groceries for the week", amount: 88.0)
Expenditure.create(date: 20210308, category_id:personal_care.id, detail:"facial moisturizer", amount: 55.0)
Expenditure.create(date: 20210308, category_id:transportation.id, detail:"gas", amount: 62.0)
Expenditure.create(date: 20210309, category_id:gift.id, detail:"birthday gift", amount: 57.0)
Expenditure.create(date: 20210309, category_id:medical.id, detail:"doctor co-pay", amount: 41.0)
Expenditure.create(date: 20210310, category_id:housing.id, detail:"partial rent", amount: 410.0)
